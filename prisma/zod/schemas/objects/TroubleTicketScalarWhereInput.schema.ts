...
const troubleticketscalarwhereinputSchema = z.object({
  AND: z.union([z.lazy(() => TroubleTicketScalarWhereInputObjectSchema), z.lazy(() => TroubleTicketScalarWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => TroubleTicketScalarWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => TroubleTicketScalarWhereInputObjectSchema), z.lazy(() => TroubleTicketScalarWhereInputObjectSchema).array()]).optional(),
...
export const TroubleTicketScalarWhereInputObjectSchema: z.ZodType<Prisma.TroubleTicketScalarWhereInput> = troubleticketscalarwhereinputSchema as unknown as z.ZodType<Prisma.TroubleTicketScalarWhereInput>;
export const TroubleTicketScalarWhereInputObjectZodSchema = troubleticketscalarwhereinputSchema;
