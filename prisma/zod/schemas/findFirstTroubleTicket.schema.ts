...
export const TroubleTicketFindFirstSelectSchema: z.ZodType<Prisma.TroubleTicketSelect> = z.object({
...
export const TroubleTicketFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    serviceNumber: z.boolean().optional(),
    tasksClassification: z.boolean().optional(),
    requestType: z.boolean().optional(),
...
export const TroubleTicketFindFirstSchema: z.ZodType<Prisma.TroubleTicketFindFirstArgs> = z.object({ select: TroubleTicketFindFirstSelectSchema.optional(), include: z.lazy(() => TroubleTicketIncludeObjectSchema.optional()), orderBy: z.union([TroubleTicketOrderByWithRelationInputObjectSchema, TroubleTicketOrderByWithRelationInputObjectSchema.array()]).optional(), where: TroubleTicketWhereInputObjectSchema.optional(), cursor: TroubleTicketWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TroubleTicketScalarFieldEnumSchema, TroubleTicketScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TroubleTicketFindFirstArgs>;

export const TroubleTicketFindFirstZodSchema = z.object({ select: TroubleTicketFindFirstSelectSchema.optional(), include: z.lazy(() => TroubleTicketIncludeObjectSchema.optional()), orderBy: z.union([TroubleTicketOrderByWithRelationInputObjectSchema, TroubleTicketOrderByWithRelationInputObjectSchema.array()]).optional(), where: TroubleTicketWhereInputObjectSchema.optional(), cursor: TroubleTicketWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TroubleTicketScalarFieldEnumSchema, TroubleTicketScalarFieldEnumSchema.array()]).optional() }).strict();