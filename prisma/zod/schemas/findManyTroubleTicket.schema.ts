...
export const TroubleTicketFindManySelectSchema: z.ZodType<Prisma.TroubleTicketSelect> = z.object({
...
export const TroubleTicketFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    serviceNumber: z.boolean().optional(),
    tasksClassification: z.boolean().optional(),
    requestType: z.boolean().optional(),
...
export const TroubleTicketFindManySchema: z.ZodType<Prisma.TroubleTicketFindManyArgs> = z.object({ select: TroubleTicketFindManySelectSchema.optional(), include: z.lazy(() => TroubleTicketIncludeObjectSchema.optional()), orderBy: z.union([TroubleTicketOrderByWithRelationInputObjectSchema, TroubleTicketOrderByWithRelationInputObjectSchema.array()]).optional(), where: TroubleTicketWhereInputObjectSchema.optional(), cursor: TroubleTicketWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TroubleTicketScalarFieldEnumSchema, TroubleTicketScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TroubleTicketFindManyArgs>;

export const TroubleTicketFindManyZodSchema = z.object({ select: TroubleTicketFindManySelectSchema.optional(), include: z.lazy(() => TroubleTicketIncludeObjectSchema.optional()), orderBy: z.union([TroubleTicketOrderByWithRelationInputObjectSchema, TroubleTicketOrderByWithRelationInputObjectSchema.array()]).optional(), where: TroubleTicketWhereInputObjectSchema.optional(), cursor: TroubleTicketWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TroubleTicketScalarFieldEnumSchema, TroubleTicketScalarFieldEnumSchema.array()]).optional() }).strict();